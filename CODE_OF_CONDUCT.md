...
This Code of Conduct applies within all community spaces of the
`panopticon-diagrams` repository, and also applies when an individual is
officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported through GitHub Security Advisories for this repository (the same
private channel used for security reports, since this project has no
dedicated abuse-reporting contact):

<https://github.com/Panopticon-Co/panopticon-diagrams/security/advisories/new>

See [`SECURITY.md`](SECURITY.md) for details on that reporting channel. All
